...
class FtpBlock(Block):
    ...
    Example:
        Load a stored value:
        ```python
        from prefect_ftp import FtpBlock
        block = FtpBlock.load("BLOCK_NAME")
        ```
    """

    _block_type_name = "ftp"
    ...
    _documentation_url = "https://ceik.github.io/prefect-ftp/blocks/#prefect-ftp.blocks.FtpBlock"  # noqa
